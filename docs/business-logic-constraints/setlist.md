...
- **BLC-SETL-002:** Reads (metadata, songs, player, export) require **read** access to that team’s library; **PUT** and **DELETE** require **library edit** access. Platform **admin** MAY read but MUST NOT mutate setlists solely by admin role.
...
- **BLC-SETL-011:** WHEN **GET /setlists/{id}**, **…/songs**, **…/player**, or **…/export** runs THEN visibility matches **GET /setlists/{id}**.
