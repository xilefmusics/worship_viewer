...
- **BLC-SONG-002:** Listing, single-song **GET**, player, export, and like endpoints require **read** access to that team’s library; **PUT** and **DELETE** require **library edit** access. Platform **admin** does **not** gain song edit solely by role.
...
- **BLC-SONG-013:** WHEN **GET …/player** or **GET …/export** runs THEN visibility matches **GET /songs/{id}**.
