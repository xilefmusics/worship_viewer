...
function DirectMediaPlayerPage() {
  ...
  return <PlayerAv type="setlist" id={`direct-media:${mediaId}`} player={player} allowNetworkFetch resourceTitle={query.data.title} allowLibraryActions={false} backToOverride="/media" backAriaKeyOverride="media.editor.backToList" />
}
